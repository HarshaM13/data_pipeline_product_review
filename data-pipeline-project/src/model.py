...
def add_sentiment(
    input_path = r"C:\Users\UKHSM003\Level7AI\Module 14 - Data Pipeline\DayOne\data-pipeline-project\data\processed\reviews_products.processed.csv",#input_path="../data/processed/reviews_products.processed.csv",
